...
if os.path.isfile(saves_path + FILE_NAME):
    ...
    emm_model = NoNaNGPDExtremeValueMixtureDensityNetwork("EMM_A1", ndim_x=ndim_x, ndim_y=1, n_training_epochs=n_epoch_emm, n_centers=3, hidden_sizes=(16,16),verbose_step=math.floor(n_epoch_emm/10), weight_decay=0.0, learning_rate=1e-2,epsilon=1e-6,l2_reg=0.0, l1_reg=0.0,dropout=0.0)
