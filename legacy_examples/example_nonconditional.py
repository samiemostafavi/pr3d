...
from pr3d.de import GaussianMM  # GammaEVM,
from utils.dataset import load_parquet

dtype = "float64"  # 'float32' or 'float16'

df = load_parquet(
    file_addresses=["dataset_onehop.parquet"], read_columns=["service_delay"]
)
print(df)
...
loaded_model = GaussianMM(h5_addr="bayes_gmm_service_delay_model.h5")

print(
    f"Model loaded, bayesian: {loaded_model.bayesian}, batch_size: {loaded_model.batch_size}"
)
