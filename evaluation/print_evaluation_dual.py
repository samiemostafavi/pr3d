...
#
#    file_addrs = ['../../data/train_records_single_p95.mat']
#    content_keys = ['train_records']
#    select_cols = [0,1]
...
evaluate_models_allstates_plot_save(cma_results=eval_results,train_len=len_train_data,model_names=['EMM','GMM'],quantiles=quantiles,xsize=xsize,markers=['s','o','v','*','x'],loglog=True,ylim_ll=[1e-4,1e2],marker_size=80,save_fig_addr=path+'eval_20k_')
...
evaluate_models_allstates_agg_save(cma_results=eval_results,train_len=len_train_data,n_epoch=n_epoch_emm,quantiles=quantiles,xsize=xsize,model_names=['EMM','GMM'],save_fig_addr=path+'eval_20k_')
...
plt.style.use('plot_style.txt')
evaluate_models_tail_agg_plot_save(tail_results,tail_x_axis,tail_x_quants,model_names=['EMM','GMM'],plotylim=[5,0],save_fig_addr=path+'eval_20k_')
